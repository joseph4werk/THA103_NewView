							...
							<div class="card">
								...
								<div class="card-body table-responsive p-0">
									<table class="table table-hover text-nowrap">
										...
										<tbody>
											<tr>
												<td><%=pubUserVO.getPubUserID()%></td>
												<td><%=pubUserVO.getPubNickname()%></td>
												<td><%=pubUserVO.getPubAccount()%></td>
												<td><%=pubUserVO.getPubAuthority()%></td>
												<td>
													<Form METHOD="post"
														ACTION="<%=request.getContextPath()%>/pubuser/pubuser.do">
														<input type="submit" value="修改"
															class="btn btn-block btn-success btn-sm"> <input
															type="hidden" name="pubUserID" value="${pubUserVO.pubUserID}">
