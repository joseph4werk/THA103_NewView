						...
						<div class="col-md-10 offset-md-1">
							...
							<div class="form-group">
								<label for="inputAuthority">使用權限：</label> <input type="radio"
									id="Authority1" name="Authority" value="A0" checked /> <label
									for="Authority1" style="margin-right: 20px;">最高權限</label> <input
									type="radio" id="Authority2" name="Authority" value="A1"
									checked /> <label for="Authority2" style="margin-right: 20px;">一般權限</label>
							</div>
							<div class="form-group">
