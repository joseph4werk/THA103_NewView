			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
						data-filter=".women">脫口秀</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
						data-filter=".men">講座</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
						data-filter=".bag">音樂會</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
						data-filter=".shoes">舞台劇</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
						data-filter=".watches">演唱會</button>
				</div>
...
<c:forEach var="activity" items="${list}">
  <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ${activity.cataClass} block2">
    <!-- Block2 -->
    <div class="block2">
      <div class="block2-pic hov-img0">
      ...
      <div class="block2-txt flex-w flex-t p-t-14">
        <p style="font-size: 11px" id="activity-datetime">
          活動日期: ${activity.activityDate} ${activity.time}
        </p>
          ...
          <div style="width: 100%; overflow: hidden">
            ...
            <div style="float: right" class="block2-txt-child2 flex-r p-t-3">
              <a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
				...
				<script>
			var strValue = '${pageContext.getAttribute("str")}';
            ...
            //--------時間格式切割方法----------
            function formatActivityDateTime(activityDateTime) {
              let dateParts = activityDateTime.split(" ");
              let datePart = dateParts[0];
              let timePart = dateParts[1];

              let time = timePart.replace(")", "");

              return `${datePart} 時間${time}`;
            }
            //--------時間格式切割方法----------
            ...
            function addAct(
              ...
              cataClass,
            	  ...
            	  console.log("cataClass:", cataClass);
              ...
              actElement.className =
                ...
                cataClass +
                " block2";
              var activityDateTime = `${activityTime} ${Time}`;
								...
								<div class="slick3 gallery-lb">
									<div id="img1YA" class="item-slick3" data-thumb="">
										<div class="wrap-pic-w pos-relative">
											<img id="img1YA" src="#" alt="IMG-PRODUCT" /> <a
												id="img1YAa"
									...
									<div class="item-slick3"
										...
										<div class="wrap-pic-w pos-relative">
											<img src="images/icons/iStock-461162561.jpg"
												alt="IMG-PRODUCT" /> <a
												class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
