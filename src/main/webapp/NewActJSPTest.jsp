                ...
                <div class="block2">
                    ...
                    <div class="block2-txt flex-w flex-t p-t-14">
                        <p style="font-size: 11px" id="activity-datetime">
                            活動日期: ${actData.actTime} ${actData.time} <!-- Adjust the attribute name as per your data model -->
                        </p>
                        <div class="block2-txt-child1 flex-col-l">
                            <div style="width: 100%; overflow: hidden">
                                <div style="float: left">
...
actImage.src = imageUrl;
    ...
    function displayReceivedData(dataArray) {
        ...
        var actImages = data.base64Images;  // 假設這是一個包含base64圖像的列表
        var actPrice = data.actPrice;
        var actIntroduce = data.actIntroduce;  // 假設你有這個字段
